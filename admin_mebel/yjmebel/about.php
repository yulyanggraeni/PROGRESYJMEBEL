...
<html lang="en">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center mb-5 pb-5">
          <div class="col-lg-7 img-years mb-5 mb-lg-0">
            <img src="images/kursi.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-4 ml-auto">
            <h3 class="mb-4">Interior dan Meubel</h3>
            <p class="mb-5">Toko YJ Mebel merupakan perusahaan yang bergerak di bidang penjualan mebel dan pembuatan perabot interior dengan 
            berbagai macam model berbahan kayu seperti meja, kursi, almari, dan jenis kerajinan kayu lainnya 
            di Kota Malang. Toko ini telah berdiri sejak tahun 1997 yang lalu.</p>
          </div>
        </div>
    ...
    <div class="site-half">
      <div class="img-bg-1" style="background-image: url('images/interior.png');"></div>
      <div class="container">
        <div class="row no-gutters align-items-stretch">
          <div class="col-md-12 col-lg-7 ml-lg-auto py-5">
            <span class="sub-title">YJ Mebel Kota Malang</span>
            <h2 class="font-weight-bold text-black font-secondary mb-4">Keunggulan</h2>
            <p>Kami menerima berbagai model produk kerajinan kayu seperti almari, meja, kursi dan pintu sesuai dengan desain yang anda butuhkan.</p>
            <p class="mb-4">Kami juga menerima kerajinan kayu untuk kelengkapan interior rumah anda sesuai model yang diinginkan. Berikut keunggulan kami :</p>  

            <ul class="list-unstyled ul-check primary">
              <li>Warna tidak cepat pudar</li>
              <li>Proses pengerjaan cepat</li>
              <li>Menerima pesanan produk custom</li>
              <li>Proses pembayaran yang mudah dan tidak berbelit</li>
              <li>Pengiriman aman dan bergaransi</li>
            </ul>
          </div>
        </div>
      </div>
