        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="#" class="d-block figure">
              <img src="images/kt-mejabelajar.jpg" alt="Image" class="img-fluid">
            </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="#" class="d-block figure">
              <img src="images/kt-mejamakan.jpg" alt="Image" class="img-fluid">
            </a>
            <h3 class="mb-0"><a href="#">Set Meja Makan</a></h3>
            <span class="text-muted">Design</span>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="#" class="d-block figure">
              <img src="images/kt-mejarias.jpg" alt="Image" class="img-fluid">
            </a>
            <h3 class="mb-0"><a href="#">Set Meja Rias</a></h3>
            <span class="text-muted">Interior</span>
          </div>

          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="#" class="d-block figure">
              <img src="images/kt-mejatv.jpg" alt="Image" class="img-fluid">
            </a>
            <h3 class="mb-0"><a href="#">Meja TV</a></h3>
            <span class="text-muted">Interior</span>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="#" class="d-block figure">
              <img src="images/kt-ranjang.jpg" alt="Image" class="img-fluid">
            </a>
            <h3 class="mb-0"><a href="#">Tempat Tidur</a></h3>
            <span class="text-muted">Design</span>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="#" class="d-block figure">
